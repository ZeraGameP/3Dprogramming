#include "main.h"
#include"../Application/Earth/Earth.h"
#include"../Application/Moon/Moon.h"
#include"../Application/Sun/Sun.h"
...
void Application::Update()
{
	//カメラ行列の更新
	{
		...
		m_spCamera->SetCameraMatrix(_mTrans);
	}
...
bool Application::Init(int w, int h)
{
	...
	// 地球初期化
	//===================================================================
	std::shared_ptr<Earth> _spEarth = std::make_shared<Earth>();
	_spEarth->Init();

	m_GameObjList.push_back(_spEarth);
	//===================================================================
	// 月初期化
	//===================================================================
	std::shared_ptr<Moon> _spMoon = std::make_shared<Moon>();
	_spMoon->Init();

	m_GameObjList.push_back(_spMoon);
	//===================================================================
	// 太陽初期化
	//===================================================================
	std::shared_ptr<Sun> _spSun = std::make_shared<Sun>();
	_spSun->Init();

	m_GameObjList.push_back(_spSun);
